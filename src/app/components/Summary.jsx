  ...
  return (
    <>
      <div className="mx-auto w-full max-w-7xl mt-20 px-6">
        ...
        <div className="flex flex-wrap justify-evenly gap-8 items-center lg:gap-4">
          ...
          <div className="flex flex-col justify-center col-span-2 order-3 xl:mr-10"> <p className="text-base font-medium leading-7 mt-3 text-gray-900 sm:tracking-tight mb-2">
