    ...
    return (
        <footer className="mt-32 mb-16 relative">
            ...
            <div className="absolute -right-32 top-0 h-full w-64 pointer-events-none hidden lg:block">
                <motion.img
                    alt="Footer Right Circle"
                    src="/circle1.svg"
                    className="absolute top-12 right-20 opacity-5"
                    width="120"
                    height="120"
            ...
            <div className="max-w-2xl mx-auto px-6 text-center relative z-10">
                {/* Frase principal */}
                <div className="mb-8">
                    <p className="text-2xl font-light text-gray-700 leading-relaxed mb-4">
                        {t("footer.quote")}
                    </p>
                ...
                <div className="flex justify-center space-x-8 mb-8">
                    <a 
                        href="https://github.com/rogeriobayer" 
                        className="group text-gray-400 hover:text-gray-700 transition-colors duration-300"
                        target="_blank"
                ...
                <div className="text-sm text-gray-500">
                    ...
                    <p className="mt-1 text-xs text-gray-400">{t("footer.madeWith")}</p>
                </div>
            </div>
        </footer>
    );
