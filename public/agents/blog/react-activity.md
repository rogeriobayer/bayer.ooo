...
- Excerpt: React 19.2 introduced the <Activity> component, which lets you hide and restore UI and internal child state without unmounting them. Learn when to use it, when to avoid it, and why it changes how we think about visibility in React.
---
